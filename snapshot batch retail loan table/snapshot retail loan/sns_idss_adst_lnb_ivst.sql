 --sqlplus -S MISADM/inni0821@INOANMIS @/inoan/dw/batch/snapshot/sns_idss_adst_lnb_ivst.sql JSNS000118 20200312
 -------------------------------------------------------------------------------- 
 -- Table Name   : IDSS_ADST_LNB_IVST
 -- Description  :
 -- Parameters   : 1. JOB ID
 --------------------------------------------------------------------------------
    ...
    BEGIN
			...
			--
             ...
             --------------------------------------------------------------------
                 ...
                 INSERT INTO IDSS_ADST_LNB_IVST
                (
                     BASC_DT       
                    ,ISYS_UPD_DTM  
                    ,APPC_NO       
