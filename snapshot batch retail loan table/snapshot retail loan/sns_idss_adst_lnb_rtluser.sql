 --sqlplus -S MISADM/inni0821@INOANMIS @/inoan/dw/batch/snapshot/sns_idss_adst_lnb_rtluser.sql JSNS000110 20200311 
 --sqlplus MISADM/inni0821@INOANMIS @/inoan/dw/batch/snapshot/sns_idss_adst_lnb_rtluser.sql JSNS000110 20200311
 --------------------------------------------------------------------------------
 -- Table Name   : IDSS_ADST_LNB_RTLUSER
 -- Description  :
 -- Parameters   : 1. JOB ID
 --------------------------------------------------------------------------------
 ...
 BEGIN
    ...
    BEGIN
			...
			INSERT INTO IDSS_ADST_LNB_RTLUSER
			(
				BASC_DT      
				,ISYS_UPD_DTM 
				,OP_NO        
