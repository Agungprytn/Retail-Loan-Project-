 --sqlplus -S MISADM/inni0821@INOANMIS @/inoan/dw/batch/snapshot/sns_idss_adst_lnb_preloninfo.sql JSNS000122 20200312
 --------------------------------------------------------------------------------
 -- Table Name   : IDSS_ADST_LNB_PRELONINFO
 -- Description  :
 -- Parameters   : 1. JOB ID
 --------------------------------------------------------------------------------
 ...
 BEGIN
    ...
    BEGIN
            ...
            -- ;    -- MAX 보관일수[6년] 현재 5년이지만, 해당년도-1에 해당하는 데이터는 보관하기 위하여
             ...
             INSERT INTO IDSS_ADST_LNB_PRELONINFO
            (
                   BASC_DT         
                  ,ISYS_UPD_DTM    
                  ,ID_NO           
             ...
             SELECT 
                  ...
                  ,UPD_DT          
                  ,UPD_TM       
                  FROM ADST_LNB_PRELONINFO@DBBCV1
                  ;
