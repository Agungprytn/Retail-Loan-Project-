 --sqlplus -S MISADM/inni0821@INOANMIS @/inoan/dw/batch/snapshot/sns_idss_adst_lnb_lmtcalrst.sql JSNS000111 20200311
 --sqlplus MISADM/inni0821@INOANMIS @/inoan/dw/batch/snapshot/sns_idss_adst_lnb_lmtcalrst.sql JSNS000111 20200311
 --------------------------------------------------------------------------------
 -- Table Name   : IDSS_ADST_LNB_LMTCALRST
 -- Description  :
 -- Parameters   : 1. JOB ID
 --------------------------------------------------------------------------------
 ...
 BEGIN
    ...
    BEGIN
			...
			--
             ...
             INSERT INTO IDSS_ADST_LNB_LMTCALRST
				(
				   BASC_DT           
				   ,ISYS_UPD_DTM      
				   ,APPC_NO           
				...
				SELECT 
				   ...
				   ,UPD_DT            
				   ,UPD_TM            
					FROM ADST_LNB_LMTCALRST@DBBCV1;
