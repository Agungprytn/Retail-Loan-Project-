 --sqlplus -S MISADM/inni0821@INOANMIS @/inoan/dw/batch/snapshot/sns_idss_adst_lnb_appclrpt.sql JSNS000120 20200311
 --sqlplus MISADM/inni0821@INOANMIS @/inoan/dw/batch/snapshot/sns_idss_adst_lnb_appclrpt.sql JSNS000120 20200311
 --------------------------------------------------------------------------------
 -- Table Name   : IDSS_ADST_LNB_APPCLRPT
 -- Description  :
 -- Parameters   : 1. JOB ID
 --------------------------------------------------------------------------------
 ...
 BEGIN
    ...
    BEGIN
             ...
             --------------------------------------------------------------------
                ...
                INSERT INTO IDSS_ADST_LNB_APPCLRPT
			    (
				   BASC_DT         
				   ,ISYS_UPD_DTM    
				   ,APPC_NO         
