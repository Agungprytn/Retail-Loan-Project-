 --sqlplus -S MISADM/inni0821@INOANMIS @/inoan/dw/batch/snapshot/sns_idss_adst_lnb_interrate.sql JSNS000128 20200311
 --sqlplus MISADM/inni0821@INOANMIS @/inoan/dw/batch/snapshot/sns_idss_adst_lnb_interrate.sql JSNS000128 20200311
 --------------------------------------------------------------------------------
 -- Table Name   : IDSS_ADST_LNB_INTERRATEuo[
 -- Description  :
 -- Parameters   : 1. JOB ID
 --------------------------------------------------------------------------------
 ...
 BEGIN
    ...
    BEGIN
			...
			INSERT INTO IDSS_ADST_LNB_INTERRATE
			(
			  BASC_DT
			  ,ISYS_UPD_DTM
			  ,PRD_CD    
			  ...
			  ,UPD_TM    
			    ...
			    SELECT
			      ...
			      ,UPD_DT    
			      ,UPD_TM    
			      FROM ADST_LNB_INTERRATE@DBBCV1;
