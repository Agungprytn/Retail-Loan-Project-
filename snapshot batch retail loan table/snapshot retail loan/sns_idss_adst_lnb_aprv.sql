 --sqlplus -S MISADM/inni0821@INOANMIS @/inoan/dw/batch/snapshot/sns_idss_adst_lnb_aprv.sql JSNS000114 20200313
 --------------------------------------------------------------------------------
 -- Table Name   : IDSS_ADST_LNB_APRV
 -- Description  :
 -- Parameters   : 1. JOB ID
 --------------------------------------------------------------------------------
 ...
 BEGIN
    ...
    BEGIN
            ...
            INSERT INTO IDSS_ADST_LNB_APRV
            (
                  BASC_DT         
                 ,ISYS_UPD_DTM    
                 ,APPC_NO         
