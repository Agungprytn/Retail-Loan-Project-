 --sqlplus -S MISADM/inni0821@INOANMIS @/inoan/dw/batch/snapshot/sns_idss_adst_lnb_dstbmng.sql JSNS000117 20200312
 --sqlplus    MISADM/inni0821@INOANMIS @/inoan/dw/batch/snapshot/sns_idss_adst_lnb_dstbmng.sql JSNS000117 20200312
 --------------------------------------------------------------------------------
 -- Table Name   : IDSS_ADST_LNB_DSTBMNG
 -- Description  :
 -- Parameters   : 1. JOB ID
 --------------------------------------------------------------------------------
    ...
    BEGIN
            ...
            -- ;    -- MAX 보관일수[6년] 현재 5년이지만, 해당년도-1에 해당하는 데이터는 보관하기 위하여
             ...
             --------------------------------------------------------------------
			    ...
			    INSERT INTO IDSS_ADST_LNB_DSTBMNG
                (
                     BASC_DT       
                    ,ISYS_UPD_DTM  
                    ,APPC_NO       
