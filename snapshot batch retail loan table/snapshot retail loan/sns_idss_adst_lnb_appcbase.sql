 --sqlplus -S MISADM/inni0821@INOANMIS @/inoan/dw/batch/snapshot/sns_idss_adst_lnb_appcbase.sql JSNS000107 20200311
 --sqlplus MISADM/inni0821@INOANMIS @/inoan/dw/batch/snapshot/sns_idss_adst_lnb_appcbase.sql JSNS000107 20200311
 --------------------------------------------------------------------------------
 -- Table Name   : IDSS_ADST_LNB_APPCBASE
 -- Description  :
 -- Parameters   : 1. JOB ID
 --------------------------------------------------------------------------------
 ...
 BEGIN
    ...
    BEGIN
             ...
             --------------------------------------------------------------------
                ...
                INSERT INTO IDSS_ADST_LNB_APPCBASE
			 (
                 BASC_DT             
                ,ISYS_UPD_DTM        
                ,APPC_NO             
