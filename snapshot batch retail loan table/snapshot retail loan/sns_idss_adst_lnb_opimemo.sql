 --sqlplus -S MISADM/inni0821@INOANMIS @/inoan/dw/batch/snapshot/sns_idss_adst_lnb_opimemo.sql JSNS000121 20200312
 --------------------------------------------------------------------------------
 -- Table Name   : IDSS_ADST_LNB_OPIMEMO
 -- Description  :
 -- Parameters   : 1. JOB ID
 --------------------------------------------------------------------------------
 ...
 BEGIN
    ...
    BEGIN
            ...
            INSERT INTO IDSS_ADST_LNB_OPIMEMO
            (
                BASC_DT       
               ,ISYS_UPD_DTM  
               ,APPC_NO       
