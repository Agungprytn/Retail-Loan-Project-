 --sqlplus -S MISADM/inni0821@INOANMIS @/inoan/dw/batch/snapshot/sns_idss_adst_lnb_interdsrgrd.sql JSNS000113 20200311
 --sqlplus MISADM/inni0821@INOANMIS @/inoan/dw/batch/snapshot/sns_idss_adst_lnb_interdsrgrd.sql JSNS000113 20200311
 --------------------------------------------------------------------------------
 -- Table Name   : IDSS_ADST_LNB_INTERDSRGRD
 -- Description  :
 -- Parameters   : 1. JOB ID
 --------------------------------------------------------------------------------
 ...
 BEGIN
    ...
    BEGIN
            ...
            -- DELETE
            -- FROM   IDSS_ADST_LNB_INTERDSRGRD
            -- WHERE  BASC_DT IN (
            --                    SELECT
			...
			INSERT INTO IDSS_ADST_LNB_INTERDSRGRD
			(
				BASC_DT
				,ISYS_UPD_DTM
				,PRD_CD    
				...
				,UPD_TM
				 ...
				 SELECT 
				   ...
				   ,UPD_DT    
				   ,UPD_TM
				   FROM ADST_LNB_INTERDSRGRD@DBBCV1;    
